...
- (void)viewDidLoad {
    ...
    //  modify by helfy   note:给手写代码留条活路吧～～
    ...
    [self.tableView addSubview:self.nodataInfoView];
}
...
//    self.tableView.scrollEnabled = !((self.dataArray.count<=0) && self.nodataInfoView);
    self.nodataInfoView.hidden = self.dataArray.count>0;
}
