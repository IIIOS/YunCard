...
- (BOOL)showLodingView;
- (NSString *)keyOfCachedArray;                     //缓存Key  默认KeyOfCachedArray
- (BOOL)showNoInfoView;                             //是否显示空数据占位图 默认为No
- (void)noInfoActionButtonClicked:(id)sender;       //空数据界面Action操作
...
- (BOOL)shouldShowRefreshAnimationWhenEntered;      //界面初始化后，是否自动显示下拉刷新动画
