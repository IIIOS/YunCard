    ...
    if(self)
    {
        ...
        switch (self.objType) {
            ...
            case YMParameterCellObjTypeTextField:
            {
                ...
                ((MTextField *)self.accessoryView).font = [UIFont systemFontOfSize:[UIFont systemFontSize]];
                self.accessoryView.backgroundColor = [UIColor clearColor];
                self.selectionStyle = UITableViewCellSelectionStyleNone;
...
-(void)setHeadImage:(UIImage *)headImage
{
    ...
    if(CGSizeEqualToSize(self.imageSize, CGSizeZero) && self.cellHeigth>10)
    {
        self.imageSize = CGSizeMake(self.cellHeigth-10, self.cellHeigth-10);
    }
}
...
//            label.textColor = [UIColor grayColor];
//            label.text =self.isRequired?@"必填":@"选填";
        }
